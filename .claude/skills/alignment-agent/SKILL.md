...
description: Phase 2 - Indexing & Alignment. Giải bài toán ghép cặp chính xác Article X của V1 với Article Y của V2 bằng BGE-M3 embedding và Hungarian Algorithm, kể cả khi bị đảo vị trí, thay đổi từ ngữ, hoặc tách/gộp.
---
