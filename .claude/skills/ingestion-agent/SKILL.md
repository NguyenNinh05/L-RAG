...
description: Phase 1 - Document parsing & knowledge representation cho văn bản pháp lý tiếng Việt. Parse PDF/DOCX thô thành Legal DOM, LSU chunking, và Hybrid Knowledge Store (Kuzu + Qdrant).
---
