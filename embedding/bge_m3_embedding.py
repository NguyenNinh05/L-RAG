...
def evaluate_speed_and_memory(model):
    print("\n" + "="*60)
    print(f"1. ĐÁNH GIÁ TỐC ĐỘ VÀ TÀI NGUYÊN (MODEL: {MODEL_NAME})")
    print("="*60)
...
def evaluate_retrieval_quality(model):
    ...
    # Model BGE-M3 xử lý nội bộ tốt, không bắt buộc cần Prefix hướng dẫn rắc rối như Multilingual-E5-Instruct
...
if __name__ == "__main__":
    print(f"Đang tải model {MODEL_NAME} (có thể sẽ mất chút thời gian tải weights nếu là lần đầu)...\n")
    # LƯU Ý: BGE-M3 có max_seq_length lên đến 8192 token (rất lớn, phù hợp RAG tài liệu dài).
